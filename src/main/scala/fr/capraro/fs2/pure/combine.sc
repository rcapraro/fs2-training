...
val odds2 = nats.map(2 * _ - 1)
odds2.take(10).toList

// Exo 2
// Implements a repeat method which takes a Stream and repeats
...
unNone(Stream(Some(1), None, Some(2)))
